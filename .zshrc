...
alias cl='CLAUDE_CODE_ENABLE_PROMPT_SUGGESTION=1 GIT_CONFIG_GLOBAL=~/dotfiles/.gitconfig ENABLE_BACKGROUND_TASKS=1 cco --chrome --add-dir ~/.local/bin --add-dir ~/.local/share/claude --add-dir ~/dotfiles --add-dir ~/.asdf --add-dir ~/Library/pnpm'
